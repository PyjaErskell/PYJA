...
use constant GC_KAPA_HM => $^O eq 'darwin' ? '/Library/Application Support/Bichon Frise/Kapa' : $^O eq 'MSWin32' ? 'C:\ProgramData\Bichon Frise\Kapa' : die "Not implemented yet on OS $^O !!!";
