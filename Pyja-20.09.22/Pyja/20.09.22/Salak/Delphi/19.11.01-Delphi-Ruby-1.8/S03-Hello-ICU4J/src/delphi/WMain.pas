...
begin
  ...
  with wu_lbx .Items do begin
    ...
    Add ( Format ( 'ICU4J spellout ENGLISH 314159265 => %s', [ wu_r .Eval ('$sf_spellout_eng') .call (314159265) ] ) );
    Add ( Format ( 'ICU4J spellout KOREA 314159265 => %s', [ wu_r .Eval ('$sf_spellout_kor') .call (314159265) ] ) );
  end;
end;
