...
Public Class WMain
  ...
  Private Sub wn_shown ( x_sender As Object, x_eas As EventArgs)
    ...
    With wu_lbx .Items
      ...
      .Add ( "Python version => " & gf_er ("$GC_PYTHON_VR") .to_s )
      .Add ( "PyQt version => " & gf_er ("$GC_PYQT_VR") .to_s )
      ...
      .Add ( "Groovy hello (English) => " & gf_er ("$sf_g_hello") .call ( "Groovy-", 5 ) )
      .Add ( "Groovy hello (Korea) => " & gf_er ("$sf_g_hello") .call ( "그루비-", 5 ) )
      .Add ( "Groovy sum of numbers => " & String .Format ( "{0:n0}", gf_er ("$sf_g_sum") .call ( 700000000, 12, 49, 15, 51, 94, 21, 63 ) ) )
      .Add ( "Python hello (English) => " & gf_er ("$sf_t_hello") .call ( "Python-", 7 ) )
      .Add ( "Python hello (Korea) => " & gf_er ("$sf_t_hello") .call ( "파이썬-", 7 ) )
      .Add ( "Python sum of numbers => " & String .Format ( "{0:n0}", gf_er ("$sf_t_sum") .call ( 700000000, 12, 49, 15, 51, 94, 21, 63 ) ) )
    End With
  End Sub
