    ...
    def nf2_qw_layout () :
      ...
      def ff3_qw_app_dirs () :
        ...
        def fp4_set_item ( x4_row, x4_item, x4_path ) :
          def pf5_qw_twi ( x5_str ) :
            fu5_twi = QTableWidgetItem (x5_str)
            fu5_twi .setFlags ( Qt.ItemIsEnabled | Qt.ItemIsSelectable ) # read only
            return fu5_twi
          fu3_tw .setItem ( x4_row, 0, pf5_qw_twi (x4_item) )
          fu3_tw .setItem ( x4_row, 1, pf5_qw_twi (x4_path) )
