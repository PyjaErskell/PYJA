...
public class ORun extends Application {
  ...
  public static String ou_py_fn = System .getenv ("SC_TONO_HM") + File.separator + "SToa.py";
  ...
  private static void __oan_run_python_script () throws Exception {
    try {
      final File bu2_fl = new File (ou_py_fn);
      if ( ! ( bu2_fl .exists () && bu2_fl .isFile () ) ) { throw new FileNotFoundException ( "Python script file not found => " + ou_py_fn ); }
      ol_jep = new Jep ();
      ol_jep .runScript (ou_py_fn);
  ...
  public static Object [] om_new_joa ( final int x_sz ) { return new Object [x_sz]; } // new java object array
}