...
class WAtQtMain ( CjAt, TgWai ) :
  ...
  def won_qw_i_fn_pb_clicked ( self, x_checked ) :
    def np2_do () :
      ...
      self .wn_log_info ( f"Total pages of the requested file => {pu2_nop:,d}" )
  ...
  def won_qw_p_do_pb_clicked ( self, x_checked ) :
    ...
    def np2_do () :
      pu2_w_lst = [ self.wu_qw_i_fn_pb, self.wu_qw_c_w, self.wu_qw_o_fn_pb, self.wu_qw_p_do_pb ]
      ...
      try :
        ...
        try :
          ...
          for bu5_i_pg_no in bu4_page_no_list :
            ...
            bu5_width_ratio = nf2_mm2pt ( self.wu_qw_c_width_mm_dsb .value () ) / bu5_i_pg_tb .getWidth ()
            bu5_height_ratio = nf2_mm2pt ( self.wu_qw_c_height_mm_dsb .value () ) / bu5_i_pg_tb .getHeight ()
            bu5_scaled_mb = nf2_scale_bx ( bu5_i_pg_mb, bu5_width_ratio, bu5_height_ratio )
            bu5_o_pg = bu3_o_doc .addNewPage ( CjPageSize (bu5_scaled_mb) )
  ...
  def wn_c_changed (self) :
      ...
      self.wu_qw_o_nfo_le .setText ( f'Size => { self.wu_qw_c_width_mm_dsb .value () } x { self.wu_qw_c_height_mm_dsb .value () } mm' )
  def wn_quit (self) :
