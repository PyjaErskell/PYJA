    ...
    def nf2_qw_layout () :
      ...
      def ff3_add_qw_config (x3_row) :
        ...
        def ff4_qw_sb () :
          ...
          fu4_sb .setPrefix ( 'repeat each page ' )
        ...
        try :
          ...
          for bu5_i_pg_no in bu4_page_no_list :
            ...
            for _ in range (bu3_repeat) :
              bu6_o_pg = bu3_o_doc .addNewPage ( CjPageSize (bu5_i_pg_mb) )
              CjPdfCanvas (bu6_o_pg) .addXObject ( bu5_pg_cp, 0, 0 )
              bu6_o_pg .setMediaBox (bu5_i_pg_mb)
              bu6_o_pg .setBleedBox (bu5_i_pg_bb)
              bu6_o_pg .setTrimBox (bu5_i_pg_tb)
              bu6_o_pg .setCropBox (bu5_i_pg_cb)
              bv4_o_nop_so_far += 1
