...
class WAtQtMain ( CjAt, TgWai ) :
  ...
  def won_qw_p_do_pb_clicked ( self, x_checked ) :
    ...
    def np2_do () :
      pu2_w_lst = [ self.wu_qw_i_fn_pb, self.wu_qw_o_fn_pb, self.wu_qw_p_do_pb ]
      ...
      try :
        ...
        try :
          ...
          random .shuffle (bu4_page_no_list)
          for bu5_i_pg_no in bu4_page_no_list :
            ...
            CjPdfCanvas (bu5_o_pg) .addXObject ( bu5_pg_cp, 0, 0 )
  ...
  def wn_c_changed (self) :
    ...
    self.wu_qw_o_nfo_le .setText ( f'{nu_o_nop:,d} page(s)' )
  def wn_quit (self) :
