...
class WAtQtMain ( CjAt, TgWai ) :
  ...
  def wn_init_ui (self) :
    ...
    def nf2_qw_layout () :
      ...
      def ff3_add_qw_config (x3_row) :
        ...
        def ff4_qw_dsb (x4_px) :
          fu4_dsb = QDoubleSpinBox ()
          fu4_dsb .setMinimum (-1_000_000)
        ...
        def ff4_left_binding_cb () :
          ...
          return fu4_cb
        self.wu_qw_c_shift_hor_mm_dsb = ff4_qw_dsb ('⇨')
        self.wu_qw_c_shift_ver_mm_dsb = ff4_qw_dsb ('⇧')
        self.wu_qw_c_duplex_cb = QCheckBox ('Duplex')
        self.wu_qw_c_left_binding_cb = ff4_left_binding_cb ()
        self.wu_qw_c_lo .addWidget (self.wu_qw_c_shift_hor_mm_dsb)
        self.wu_qw_c_lo .addItem ( QSpacerItem ( 10, 1, QSizePolicy.Fixed, QSizePolicy.Minimum ) )
        self.wu_qw_c_lo .addWidget (self.wu_qw_c_shift_ver_mm_dsb)
        self.wu_qw_c_lo .addItem ( QSpacerItem ( 10, 1, QSizePolicy.Fixed, QSizePolicy.Minimum ) )
        self.wu_qw_c_lo .addWidget (self.wu_qw_c_duplex_cb)
        self.wu_qw_c_lo .addItem ( QSpacerItem ( 10, 1, QSizePolicy.Fixed, QSizePolicy.Minimum ) )
        self.wu_qw_c_lo .addWidget (self.wu_qw_c_left_binding_cb)
    ...
    self.wu_qw_c_shift_hor_mm_dsb.valueChanged .connect (self.wn_c_changed)
    self.wu_qw_c_shift_ver_mm_dsb.valueChanged .connect (self.wn_c_changed)
    self.wu_qw_c_duplex_cb.stateChanged .connect (self.wn_c_changed)
  ...
  def won_qw_p_do_pb_clicked ( self, x_checked ) :
    ...
    def nf2_shift_mb ( x2_org_mb, x2_x, x2_y ) :
      fu2_x = min ( x2_org_mb .getX (), x2_org_mb .getX () + x2_x )
      fu2_y = min ( x2_org_mb .getY (), x2_org_mb .getY () + x2_y )
      fu2_w = x2_org_mb .getWidth () + abs (x2_x)
      fu2_h = x2_org_mb .getHeight () + abs (x2_y)
    ...
    def np2_do () :
      ...
      try :
        ...
        try :
          ...
          bu4_shift_hor = nf2_mm2pt ( self.wu_qw_c_shift_hor_mm_dsb .value () )
          bu4_shift_ver = nf2_mm2pt ( self.wu_qw_c_shift_ver_mm_dsb .value () )
          bu4_simplex = not self.wu_qw_c_duplex_cb .isChecked ()
          bu4_left_binding = self.wu_qw_c_left_binding_cb .isChecked ()
          ...
          for bu5_i_pg_no in bu4_page_no_list :
            bu5_is_even_pg = bu5_i_pg_no % 2 == 0
            bu5_x = bu4_shift_hor if bu4_simplex else -bu4_shift_hor if ( bu5_is_even_pg and bu4_left_binding ) else bu4_shift_hor
            bu5_y = bu4_shift_ver if bu4_simplex else -bu4_shift_ver if ( bu5_is_even_pg and bu4_top_binding ) else bu4_shift_ver
            ...
            bu5_o_pg = bu3_o_doc .addNewPage ( CjPageSize (bu5_i_pg_mb) )
            CjPdfCanvas (bu5_o_pg) .addXObject ( bu5_i_pg .copyAsFormXObject (bu3_o_doc), bu5_x, bu5_y )
            bu5_o_pg .setMediaBox ( nf2_shift_mb ( bu5_i_pg_mb, bu5_x, bu5_y ) )
  ...
  def wn_c_changed (self) :
    self.wu_qw_c_left_binding_cb .setVisible ( self.wu_qw_c_duplex_cb .isChecked () )
    self.wu_qw_c .setEnabled (True)
    self.wu_qw_o_fn_pb .setEnabled (True)
    nu_shift_hor = self.wu_qw_c_shift_hor_mm_dsb .value ()
    nu_shift_ver = self.wu_qw_c_shift_ver_mm_dsb .value ()
    self.wu_qw_p_do_pb .setEnabled ( not ( nu_shift_hor == 0 and nu_shift_ver == 0 ) )
    self.wu_qw_o_nfo_le .setText ( f'{self.wv_i_nop:,d} page(s)' )
  def wn_quit (self) :
