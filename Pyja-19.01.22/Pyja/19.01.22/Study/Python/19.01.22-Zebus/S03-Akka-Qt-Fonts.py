...
class WAtQtMain ( CjAt, TgWai ) :
  ...
  def wn_init (self) :
    ...
    self .wn_move_center ()
    self .wn_change_font ()
    self .getContext () .system () .scheduler () .schedule ( CjDuration .Zero (), CjDuration .create( 100, CjTimeUnit.MILLISECONDS ), self .getSelf (), CjSymbol ('LNextFont'), self .getContext () .system () .dispatcher (), None )
