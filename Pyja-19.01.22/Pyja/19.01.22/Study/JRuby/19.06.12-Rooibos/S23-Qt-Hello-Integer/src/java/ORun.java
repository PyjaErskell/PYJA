...
public class ORun {
  ...
  public static String ou_gr_fn = System .getenv ("SC_TONO_HM") + File.separator + "src" + File.separator + "groovy" + File.separator + "SToa.groovy";
  public static ScriptEngine ol_jr;
  public static String ou_jr_fn = System .getenv ("SC_TONO_HM") + File.separator + "src" + File.separator + "jruby" + File.separator + "SToa.rb";
