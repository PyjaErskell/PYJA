...
gp_xr = { xp_it -> javafx.application.Platform .runLater { gy_tc { xp_it () } } } // JavaF(x) (r)un
...
gp_request_exit = { x_ec, x_ex_list = [] -> javafx.application.Platform .runLater { __gap_request_exit x_ec, x_ex_list } }
