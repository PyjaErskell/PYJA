...
gf_new_python = {
  fp2_prepare_4_windows = {
    ...
    DgEnv .df_set_env 'PYTHONPATH', [
      ...
      gf_pj ( fu2_python_hm, 'lib' ),
      gf_pj ( fu2_python_hm, 'lib', 'site-packages' ),
      gf_pj ( fu2_python_hm, 'lib', 'site-packages', 'Pythonwin' ),
      gf_pj ( fu2_python_hm, 'lib', 'site-packages', 'win32' ),
      gf_pj ( fu2_python_hm, 'lib', 'site-packages', 'win32', 'lib' ),
      gf_pj ( fu2_python_hm, 'python36.zip' ),
    ] .join (GC_PASA)

    pp3_add_jep_jar = {
      final pu3_pn = gf_pj fu2_python_hm, 'Lib', 'site-packages', 'jep'
      final pu3_fn = gf_pj pu3_pn, 'jep-3.7.1.jar'
      gp_add_java_library_path pu3_pn
      gp_add_jar pu3_fn
    }
    pp3_add_jep_jar ()
  }
  if ( CgPlatform .isWindows () ) fp2_prepare_4_windows ()
  gf_cls ('jep.Jep') .newInstance false, '.'
}
