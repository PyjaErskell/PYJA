...
"$SC_J8_X_FN" "$SC_JAVA_XMX" -XstartOnFirstThread -cp "$SC_QTJ_JAR_FN":"$SC_SCALA_LIB_JAR_FN":"$SC_JAR_FN" -Djava.library.path="$SC_QTJ_LIB_PN" -DSC_THIS_JAR_FN="$SC_JAR_FN" OStart "$@"
