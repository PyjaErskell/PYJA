...
class WAtMain < CgAt
  ...
  def receive x_letter
    case x_letter
    when :LNextFont then gp_xr { wn_change_font }
    end
  end
  def wn_init
    ...
    @wv_msg = ''
    @wu_bn .set_on_action { wn_change_font }
    wn_change_font
    @wu_root .tap { |it|
    ...
    @wu_stage .tap { |it|
      ...
      it .set_on_shown {
        ...
        @wu_scheduler = context.system.scheduler .schedule CgDuration.zero, ( CgDuration .create 100, CgTimeUnit::MILLISECONDS ), get_self, :LNextFont, get_self.dispatcher, get_self
      }
  ...
  def wn_change_font
    ...
    @wu_bn.style = "-fx-font-family : '#{nu_fnt_nm}'; -fx-font-size : 27px;"
