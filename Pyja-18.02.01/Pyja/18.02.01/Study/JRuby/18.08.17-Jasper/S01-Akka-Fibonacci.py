...
def jy_rf ( x_nm, *x_args ) : return JC_JR. invokeFunction ( x_nm, jf_script_params (x_args) )
def jy_rm ( x_oj, x_nm, *x_args ) : return JC_JR. invokeMethod ( x_oj, x_nm, jf_script_params (x_args) )

jy_rf ( 'gp_set_const', 'GC_PYTHON_VR', GC_PYTHON_VR )
jy_rf ( 'gp_set_const', 'GC_TCL_VR', GC_TCL_VR )
jy_rf ( 'gp_set_const', 'GC_PYQT_VR', GC_PYQT_VR )
jy_rf ( 'gp_set_const', 'GC_TOTAL_CPU', GC_TOTAL_CPU )
jy_rf ( 'gp_set_const', 'GC_TOTAL_MEMORY', GC_TOTAL_MEMORY )
jy_rf ( 'gp_set_const', 'GC_HOST_NM', GC_HOST_NM )
jy_rf ( 'gp_set_const', 'GC_CUSR', GC_CUSR )
jy_rf ( 'gp_set_const', 'GC_THIS_EXE_FN', GC_THIS_EXE_FN )
jy_rf ( 'gp_set_const', 'GC_THIS_CMD', GC_THIS_CMD )
jy_rf ( 'gp_set_const', 'GC_ARGV', GC_ARGV )
jy_rf ( 'gp_set_const', 'GC_DESKTOP_PN', GC_DESKTOP_PN )
...
def jp_request_exit ( x_ec, x_ex_list = None ) : jy_rf ( 'gp_request_exit', x_ec, x_ex_list )
