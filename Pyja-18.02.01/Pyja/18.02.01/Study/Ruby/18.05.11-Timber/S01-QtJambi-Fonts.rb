...
jy_ge <<-JASH_EOS.unindent
  gp_bn = { final long x_bi, final String x_nethod_nm, final Object... x_args ->
    GC_IR .in_it ( x_bi, x_nethod_nm, *x_args )
  }
...
class WMain
  ...
  def wn_init
    @wu_bi = gf_bi self
    @wu_mw = jf_jcls('com.trolltech.qt.gui.QMainWindow').new
    @wu_lo = jf_jcls('com.trolltech.qt.gui.QVBoxLayout').new
    @wu_pb = jy_ge <<-NASH_EOS.unindent
      import com.trolltech.qt.gui.QSizePolicy
      new com.trolltech.qt.gui.QPushButton () .with {
        setSizePolicy QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed
        it .clicked .connect gf_qs { x_checked -> gp_bn #{@wu_bi}, 'wn_change_font' }
        it
      }
    NASH_EOS
    @wu_lb = jy_ge <<-NASH_EOS.unindent
      new com.trolltech.qt.gui.QLabel () .with {
        setAlignment com.trolltech.qt.core.Qt$AlignmentFlag.AlignCenter
        it
      }
    NASH_EOS
    ...
    @wu_fnt_families = jf_jcls('com.trolltech.qt.gui.QFontDatabase').new.families
  ...
  def wn_change_font
    ...
    @wu_pb.setFont jf_jcls('com.trolltech.qt.gui.QFont').new nu_fnt_nm, 17
...
module DBody
  def self.dp_it
    JC_QAPP .initialize []
    JC_QAPP .setStyle jf_jcls('com.trolltech.qt.gui.QPlastiqueStyle').new
    pu_main = WMain .new
    JC_QAPP .execStatic
  end
end
