...
namespace Global {
  ...
  void jp_on ( at_c(jobject) x_oj, at_c(jmethodID) x_mi, ... ) { // call (o)bject (n)ethod
    va_list fl_args;
    va_start ( fl_args, x_mi );
    zp_xie ( CallObjectMethodV ( x_oj, x_mi, fl_args ) );
    va_end (fl_args);
  }
  ...
  void jp_sn ( at_c(jclass) x_cls, at_c(jmethodID) x_si, ... ) { // call (s)tatic object (n)ethod
    va_list fl_args;
    va_start ( fl_args, x_si );
    zp_xie ( CallStaticObjectMethodV ( x_cls, x_si, fl_args ) );
    va_end (fl_args);
  }
  ...
  auto jf_se ( at_cr(CgQS) xr_ngin_nm ) {
  ...
  auto jy_se_eval ( at_cr(jobject) xr_se, at_ct(char) xt_str ) {
    return jf_om (
      xr_se,
...
class WMain : public QMainWindow {
  Q_OBJECT
public :
  at_c(CgQS) wu_app_nm = "MyApp";
  at_c(CgQS) wu_app_vr = "1.2.3";
  at_c(CgQS) wu_app_au = "Harawata";
  ...
  QTableWidget * wm_init_appdirs () {
    ...
    ay_br (
      at_ca pu2_ad = ay_br (
        at_ca fu3_cls = jf_fc ("net/harawata/appdirs/AppDirsFactory");
        return jf_sm ( fu3_cls, jf_si ( fu3_cls, "getInstance", "()Lnet/harawata/appdirs/AppDirs;" ) );
      );
      at_ca pu2_cls = jf_fc ("net/harawata/appdirs/AppDirs");
      at_ca pu2_sig = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;";
      at_ca pu_nm = jf_ns (wu_app_nm);
      at_ca pu_vr = jf_ns (wu_app_vr);
      at_ca pu_au = jf_ns (wu_app_au);
      mp2_set_item ( 0, "User data path",   zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getUserDataDir",   pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
      mp2_set_item ( 1, "User config path", zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getUserConfigDir", pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
      mp2_set_item ( 2, "User cache path",  zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getUserCacheDir",  pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
      mp2_set_item ( 3, "User log path",    zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getUserLogDir",    pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
      mp2_set_item ( 4, "Site data path",   zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getSiteDataDir",   pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
      mp2_set_item ( 5, "Site config path", zf_qs ( jf_om ( pu2_ad, jf_mi ( pu2_cls, "getSiteConfigDir", pu2_sig ), pu_nm, pu_vr, pu_au ) ) );
    );
...
#include "S01-Harawata-AppDirs.moc"
