      ...
      try :
        ...
        try :
          ...
          for bu5_i_pg_no in range ( 1, bu3_i_nop+1 ) :
            ...
            bu5_i_pg_bb_sz = bu5_i_pg .getCropBox ()
            bu5_i_pg_tb_sz = bu5_i_pg .getTrimBox ()
            bu5_o_pg_cp = bu5_i_pg .copyAsFormXObject (bu4_o_doc)
            bu4_cache [bu5_i_pg_no] = [ bu5_i_pg_bb_sz, bu5_i_pg_tb_sz, bu5_o_pg_cp ]
          for bu5_iteration in range ( 1, bu3_repeat+1 ) :
            ...
            for bu6_i_pg_no in range ( 1, bu3_i_nop+1 ) :
              bu6_o_pg_bb_sz = bu4_cache [bu6_i_pg_no] [0]
              bu6_o_pg_tb_sz = bu4_cache [bu6_i_pg_no] [1]
              bu6_o_pg_cp = bu4_cache [bu6_i_pg_no] [2]
              bu6_o_pg = bu4_o_doc .addNewPage ( CjPageSize (bu6_o_pg_bb_sz) )
              CjPdfCanvas (bu6_o_pg) .addXObject ( bu6_o_pg_cp, 0, 0 )
              bu6_o_pg .setTrimBox (bu6_o_pg_tb_sz)
              bv4_o_nop_so_far += 1
