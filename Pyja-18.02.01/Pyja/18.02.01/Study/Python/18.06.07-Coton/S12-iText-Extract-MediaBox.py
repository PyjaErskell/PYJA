...
class WMain ( QMainWindow, TgWai ) :
  ...
  def wn_set_output_fn (self) :
    ...
    self.wu_le_o_bn .setText ( f'{ gf_jn ( self.wu_le_i_bn .text () ) }-(ExtractMediaBox)-{nu_o_nop:d}-page(s).pdf' )
      ...
      try :
        ...
        try :
          ...
          for bu5_i_pg_no in range ( 1, bu3_i_nop+1 ) :
            ...
            bu5_i_pg_sz = bu5_i_pg .getMediaBox ()
            bu5_i_pg .setCropBox (bu5_i_pg_sz)
            bu5_o_pg_cp = bu5_i_pg .copyAsFormXObject (bu4_o_doc)
            bu5_o_pg = bu4_o_doc .addNewPage ( CjPageSize (bu5_i_pg_sz) )
